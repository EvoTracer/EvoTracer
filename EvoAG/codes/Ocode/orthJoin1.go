//orthJoin1.go: Joining the ortholog blocks from two ORTH_COMBINED files
//USAGE: ./orthJoin1  ORTH_COMBINED_FILE_1  ORTH_COMBINED_FILE_2  SP_1  SP_2
...
func main () {
  usage := "orthJoin: to join the ortholog blocks from two ORTH_COMBINED files.\n\n" + "./orthJoin1  ORTH_COMBINED_FILE_1  ORTH_COMBINED_FILE_2  SP_1  SP_2 > ORTH_JOINING_RESULTS\n\n"
  if len(os.Args) < 5 {
    fmt.Printf("%s",usage)
    return
  }
